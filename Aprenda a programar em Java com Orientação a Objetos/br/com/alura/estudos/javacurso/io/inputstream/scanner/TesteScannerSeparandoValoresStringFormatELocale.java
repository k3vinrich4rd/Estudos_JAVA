...
public class TesteScannerSeparandoValoresStringFormatELocale {
...
//            System.out.println(line);
            ...
            secondInput.useLocale(Locale.US);
            ...
            String stringFormat = String.format(new Locale("pt", "BR"),"%s - %04d-%08d %20s: %.2f", typeAccount, agency, number, holder, balance);
