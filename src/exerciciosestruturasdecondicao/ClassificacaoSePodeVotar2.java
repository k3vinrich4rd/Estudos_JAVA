...
// utilizando if (se), else if (se não se) e conectivos lógicos, como:
// && (e) e || (ou)
// Verificando se uma pessoa pode votar ou não, através do seu ano de nascimento.

public class ClassificacaoSePodeVotar2 {
    public static void main(String[] args) {
        ...
        } else if ((idade >= 16 && idade < 18) || (idade > 70)) { // Quando se trata do conectivo lógico && (e)
