...
public class LigarParaUmAmigo {
    public static void main(String[] args) {
        ...
        System.out.print("Você tem um celular ou um número desejado, para efetuar a ligação? [S]im / N[ão]: ");
        ...
        do {
            ...
            if (respostaDoUsuario.equalsIgnoreCase("s")) {
                ...
                System.out.println("Tenha um celular ou número de telefone para efetuar uma ligação. ");
                break;
            }
